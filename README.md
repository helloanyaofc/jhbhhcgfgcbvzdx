...
local Window = Fluent:CreateWindow({Title = "❤️Anya Hub❤️",SubTitle = "| By:Luan Valentines Day Edition",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Rose",MinimizeKey = Enum.KeyCode.End})
